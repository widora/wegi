...
//	continue;
	...
	egi_imgbuf_windisplay(weather_data[nday].eimg, &vfb, WEGI_COLOR_GRAYC, 0, 0, pixlen, subindex*60, 60, 60);
        ...
        sprintf(strbuff,"%s  %s%s级",weather_data[nday].cond_txt,
        ...
        sprintf(strbuff, "温度%d/%dC  湿度%d%%",weather_data[nday].temp_max, weather_data[nday].temp_min,
